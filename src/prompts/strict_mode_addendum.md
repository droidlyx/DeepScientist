This quest has opted into **strict mode**. The following process
...
strict-mode rule gets skipped. If you catch yourself thinking one of
...
These rules apply only because the user turned on strict mode.
Outside strict mode, the default skill contracts remain authoritative
